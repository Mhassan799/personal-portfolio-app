            ...
            <div className="col-md-4">
              <div className="card rounded">
                <div className="card-image">
                  <span className="card-notify-badge">Full stack</span>
                  <img
                    src="https://www.netsolutions.com/insights/wp-content/uploads/2023/04/Why-your-business-needs-mobile-eCommerce-apps.png"
                    alt="project1"
                  />
                </div>
                <div className="card-image-overly m-auto mt-3">
            ...
            <div className="col-md-4">
              <div className="card rounded">
                <div className="card-image">
                  <span className="card-notify-badge">Full stack</span>
                  <img
                    src="https://images.unsplash.com/photo-1610563166150-b34df4f3bcd6?q=80&w=1000&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8Y29kaW5nJTIwc2V0dXB8ZW58MHx8MHx8fDA%3D"
                    alt="project1"
                  />
                </div>
                <div className="card-image-overly m-auto mt-3">
